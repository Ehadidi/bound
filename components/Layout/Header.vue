<template>
    <header class="bg-white px-3">
            ...
            <div class="container">
                <div class="d-flex align-items-center justify-content-between">
                    <div v-if="!IsAuth" class="d-flex items-start gap-2">
                        ...
                        <button @click="auth_modal = true" class="btn p-0 w-fit min-w-min h-fit">
                            {{ $t("header.auth") }}
                        </button>
                    </div>
                        ...
                        <div class="dropdown" ref="target">
                            ...
                            <Transition name="dropShow">
                                <ul v-if="dropShown" class="dropdown-menu">
                                    ...
                                    <li>
                                        <NuxtLink class="dropdown-item defualt-link" @click="
                                        dropShown = !dropShown;
        ...
        <Dialog class="site-modal none-header" v-model:visible="terms_conditions" modal :style="{ width: '50vw' }"
        ...
        <Dialog class="site-modal search-box none-header" v-model:visible="search" modal :style="{ width: '50rem' }"
            :breakpoints="{ '1199px': '75vw', '575px': '90vw' }">
