                    ...
                    <div class="col-12 md:col-6">
                        ...
                        <form ref="contactForm" @submit.prevent="contact_us">
                            <FormInput InputClass="validated" @change="change_valid" :label="$t('form_layout.name')"
                                :placeholder="$t('form_layout.enter_name')" :model="form" name="name" type="text"
                                ...
                                <template #addition>
                                    <div class="flex align-items-center gap5 height50 px-2">
                                        <input style="background-color: transparent;"
                                            class="width40 height50 border-0 font13" readonly type="text"
                            ...
                            <FormInput InputClass="validated height120" @change="change_valid" :textarea="true"
                                :label="$t('form_layout.message')" :placeholder="$t('form_layout.enter_message')"
                                :model="form" name="message" type="text" parentClass="my-3" :icon="true">
                                <template #icon>
