      ...
      <div class="container">
        <div class="grid">
          <div class="col-12 md:col-6">
            ...
            <span class="montagu mb-0 font30 d-block text-primary"
            ...
            <form ref="contactForm" @submit.prevent="contact_us">
              <FormInput
                ...
                @change="handleChange"
                :label="$t('form_layout.name')"
                :placeholder="$t('form_layout.enter_name')"
                :model="form"
                name="name"
                type="text"
                parentClass="my-3"
              ...
              <FormInput
                InputClass="validated"
                @change="handleChange"
                :label="$t('form_layout.subject')"
                :placeholder="$t('form_layout.enter_subject')"
                :model="form"
                name="subject"
                type="text"
                parentClass="my-3"
              ...
              <FormInput
                InputClass="validated height120"
                @change="handleChange"
                :textarea="true"
                :label="$t('form_layout.message')"
                :placeholder="$t('form_layout.enter_message')"
                :model="form"
                name="message"
                type="text"
                parentClass="my-3"
...
const contact_us = async () => {
  ...
  let valid = validate(contactForm.value, t).valid;
