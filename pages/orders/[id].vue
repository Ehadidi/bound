  ...
  <section class="bg-sectionBg">
    ...
    <div class="container">
      <div class="py-5">
        ...
        >
          <div
            class="status-progress d-flex align-items-center flex-wrap"
            v-if="order_status < 8"
          >
            <div
            ...
            >
              ...
              >
                <i
                  ...
                  v-if="isActiveState(item.states)"
                ></i>
              </div>
              <div v-if="item.content">
                ...
                <span
                  class="fw-bold d-block mt-1"
                  v-if="status.state === 'preparing' && index == 2"
                  >{{ $t("orders.preparing") }}</span
                >

                <span
                  class="fw-bold d-block mt-1"
                  v-if="status.state === 'out_for_delivery' && index == 2"
                  >{{ $t("orders.out_delivery") }}</span
                >

                <span
                  class="fw-bold d-block mt-1"
                  v-if="status.state === 'delivered' && index == 2"
                  >{{ $t("orders.delivered") }}</span
                >

                <span
                  class="fw-bold d-block mt-1"
                  v-if="status.state === 'Retrieving' && index == 2"
          ...
          <NuxtLink
            :to="localPath(`/orders/rate/${route.params.id}`)"
            v-if="order_status == 7"
            class="btn btn-primary arrow-effect mb-3"
          >
            ...
            <div class="mb-4">
              ...
              <div class="bg-white p-3 main_shadow">
                ...
                >
                  ...
                  <button
                    v-if="order_status < 6 && order_status > 2"
                    class="btn btn-outline-danger up fw-bold min-w-unset mb-3 h-40px"
                    @click="report_modal = true"
                  >
                    {{ $t("layout.report") }}
                    <img
            ...
            <div class="mb-4">
              ...
              <div class="bg-white p-3 main_shadow">
                ...
                <div class="cart_text mb-2">
                  ...
                  <span
                    >{{ payment_details.refundable_deposit }}
                    {{ $t("product.currency") }}</span
                  >
                </div>
                ...
                <div class="cart_text mb-2">
                  ...
                  <span
                    >{{ payment_details.delivery_price }}
                    {{ $t("product.currency") }}</span
                  >
                </div>
                  ...
                  >
                    <div class="left">
                      ...
                      <div class="product_info">
                        ...
                        <div
                          class="flex align-items-center gap5"
        ...
        >
          ...
          <form class="w-100" @submit.prevent="report_order" ref="report_form">
            ...
            <div class="d-flex justify-content-between gap-2 w-100 mt-4">
              <button
                type="button"
                class="btn sm transparent btn-primary flex-1"
        ...
        >
          ...
          <div class="d-flex justify-content-between gap-2 w-100">
            <button
              ...
              class="btn sm btn-primary flex-1 up"
              @click="cancel_order"
            >
              <div
            ...
            <button
              class="btn sm btn-danger flex-1 up"
