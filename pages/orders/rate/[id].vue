        ...
        <ClientOnly>
            <div class="container">
                <div class="grid">
                    ...
                    <div class="col-12 md:col-8 lg:col-7 mx-auto bg-white main_shadow p-0">
                        <div v-for="(item, index) in products" :key="index"
                            ...
                            <div class="flex align-items-center gap20">
                                <img class="height150" :src="item.product_image" :alt="item.product_name">
                    ...
                    <div class="col-12 md:col-8 lg:col-7 mx-auto">
                        <button class="btn btn-primary mx-auto" @click="confirm_rating" :disabled="!isRated">{{
                                $t("layout.confirm_rate")
                            }}</button>
                    </div>
                </div>
            </div>
...
const confirm_rating = async () => {
    ...
    if (status === "success") {
        ...
        show_ratings()
        isRated.value = false
        router.push({ path: `/orders/${route.params.id}` })
