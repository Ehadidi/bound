<template>
  <div class="bg-sectionBg">
        ...
        <div class="row">
                  ...
                  <div class="left">
                    ...
                    <div class="product_info">
                      ...
                      <div class="info">
                        <span>{{ item.date }}</span>
                        <span
                          >({{ item.duration }}{{ $t("product.unit") }})</span
                        >
                        <button
          ...
          <form class="col-xl-4 col-lg-5">
            ...
            <div class="bg-white py-4 px-3 main_shadow mb-4">
              ...
              <FormInput
                :label2="$t('cart.location')"
                :placeholder="$t('cart.location')"
                :model="form"
                readonly
                name="location"
                type="text"
              ...
              >
                ...
                <template #addition>
                  <button
                    class="btn border-0 min-w-min h-100 bg-transparent underline"
                    type="button"
            ...
            <div class="bg-white p-4 main_shadow">
              ...
              <div class="cart_text mb-2">
                ...
                <span
                  >{{ cartSummary.total_refundable_value }}
                  {{ $t("product.currency") }}</span
                >
              </div>
              ...
              <button
                type="button"
                class="btn btn-primary arrow-effect ms-auto"
                @click="confirm_order"
              >
                {{ $t("cart.sendOrder") }}
    ...
    >
      <div class="container" v-if="address_modal">
        ...
        <div class="flex align-items-center justify-content-center my-4 gap20">
          ...
          <button
            class="btn btn-outline-primary up"
    ...
    >
      <div class="container">
        <div
          class="flex justify-content-center align-items-center flex-column py-5 gap30"
        >
          <img
          ...
          <div class="d-flex gap-2">
            <NuxtLink
              :to="localPath('/')"
              class="btn sm transparent btn-primary"
            >
              {{ $t("cart.done.home") }}
            </NuxtLink>
