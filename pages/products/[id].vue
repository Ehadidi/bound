                ...
                <div class="row gy-4" v-if="!loading">
                    ...
                    <div class="col-xl-4 col-lg-7">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="fs15 c-primary fw-bold mt-1">{{ product.price }} {{ $t("product.currency") }} / {{
                                $t("product.unit") }}</div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="pro_filter_btns mt-2">
                                <label class="pro_btn" v-for="color in product.imagesAndColors" :key="color.id">
                                    <input type="radio" name="color" @change="changeColor(color.color_id)"
                                        v-model="selectedColor" :value="color.color_id">
                                    {{ color.color }}
                        ...
                        <div class="rent_date">
                            <div class="my-2">
                                ...
                                <div class="form-inputs height50">
                                    <Calendar dateFormat="yy-m-d" ref="calender" :minDate="today" v-model="start_date"
                                        showIcon icon="pi pi-calendar" :placeholder="$t('product.selectDate')"
                                        name="time" />
                                </div>
                            </div>
                            <div class="mt-4" v-if="start_date">
                                ...
                                <div class="flex align-items-center justify-content-center">
                                    <button @click="add_to_cart" style="min-width: 135px;"
