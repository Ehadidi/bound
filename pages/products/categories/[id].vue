        ...
        <form @submit.prevent="handelFilter" ref="filter">
          ...
          $t("layout.sub_category")
                ...
                <div class="form-inputs">
                  <Dropdown filter v-model="filterForm.sub_category" :options="categories" optionLabel="name"
          ...
          $t("layout.price")
                ...
                <form-radio-group :options="priceOptions" :model="filterForm" name="sort_by" isColumn>
                </form-radio-group>

                <div class="d-flex flex-wrap">
                  <FormInput :placeholder="$t('layout.from')" :model="filterForm" name="price_from" type="text"
                    parentClass="col-12 lg:col-6" :icon="false">
                  </FormInput>
                  <FormInput :placeholder="$t('layout.to')" :model="filterForm" name="price_to" type="text"
                    parentClass="col-12 lg:col-6" :icon="false">
                  </FormInput>
                </div>
              </div>
            ...
            <div class="col-lg-9 col-md-8 col-sm-7 py-3">
              ...
              <div v-if="products.length" class="d-grid product-slide mt-4">
                <div v-if="loading" class="product-slide-item mb-4 mx-1" v-for="i in 17" :key="i">
                  <Skeleton class="product-item" height="9rem"></Skeleton>
                </div>
                <div v-else class="product-slide-item mb-4" v-for="product in products" :key="product.id">
